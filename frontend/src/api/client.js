...
export const logsApi = {
  ...
  add: (food_id, date, portion_multiplier = 1) => api.post('/logs', { food_id, date, portion_multiplier }),
  updateMultiplier: (id, portion_multiplier) => api.patch(`/logs/${id}`, { portion_multiplier }),
